    ...
    render() {
        return (
            <div>
                ...
                <div><label>Soal</label><br />
                    <input type="text" id="soal" /></div>
                <div><label>Jawaban A</label><br />
                    <input type="text" id="jba" /></div>
                <div><label>Jawaban B</label><br />
                    <input type="text" id="jbb" /></div>
                <div><label>Jawaban C</label><br />
                    <input type="text" id="jbc"/></div>
                <div>
                    <label>Jawaban D</label><br />
                    <input type="text" id="jbd" />
                </div>
                <div>
                    <label>Kunci</label><br />
                    <input type="text" value="kunci"/>
                </div>
                <div>
